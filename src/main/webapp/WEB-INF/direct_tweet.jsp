...
for (Entity result : pq.asIterable()) {
	...
	//  out.println("check"+s.getProperty("visited_count"));
	  ds.put(s);
	  out.println("<h1>Tweet of "+ s.getProperty("first_name")+" "+s.getProperty("last_name")+"</h1>");
	  ...
	  out.println("<tr><h3><div id=status> "+s.getProperty("first_name")+"'s Tweet says: "+status +"</div></h3></tr>");
